"""
fa036 — Weekly Lifecycle Autonomy Scorecard tests.

Covers the five-metric brain in `src/tasks/lifecycle_autonomy_report.py`, the
...
Pattern mirrors `tests/test_lifecycle_self_healing.py`.
...
Test ledger (25):
  ...
  20. ab_engine.complete_test writes playbook with source_actor='lifecycle'
...
class TestMetric1AutonomousPct:
    ...
    def test_with_data(self):
        ...
        from src.tasks.lifecycle_autonomy_report import _metric_1_autonomous_pct
...
class TestMetric2OverriddenPct:
    ...
    def test_counts_overridden_at(self):
        ...
        from src.tasks.lifecycle_autonomy_report import _metric_2_overridden_pct
...
class TestMetric3Adoptions:
    ...
    def test_passes_since_window(self):
        ...
        from src.tasks.lifecycle_autonomy_report import _metric_3_adoptions
...
class TestMetric4ApprovalLatency:
    ...
    def test_returns_null_with_note_when_no_data(self):
        ...
        from src.tasks.lifecycle_autonomy_report import _metric_4_approval_latency
...
class TestMetric5NetNewPlaybooks:
    ...
    def test_subtracts_retired(self):
        ...
        from src.tasks.lifecycle_autonomy_report import _metric_5_net_new_playbooks
...
class TestRunAutonomyReport:
    ...
    def test_writes_learning_card(self):
        ...
        from src.tasks.lifecycle_autonomy_report import run_autonomy_report
        ...
        with patch("src.tasks.lifecycle_autonomy_report.get_db_context", _ctx), \
             patch("src.tasks.lifecycle_autonomy_report._post_slack_summary"):
    ...
    def test_handles_all_null_gracefully(self):
        ...
        from src.tasks.lifecycle_autonomy_report import compute_autonomy_metrics
...
class TestRevenuePulseAutonomyLine:
    ...
    def test_appends_line_when_card_exists(self):
        ...
        from src.tasks.revenue_pulse import _format_lifecycle_autonomy_weekly_summary
        ...
        line = _format_lifecycle_autonomy_weekly_summary(sess)
...
class TestAbEngineSourceActor:
    ...
    def test_default_actor_is_lifecycle(self):
        """Test #20 — automatic ab_rollback_check path → authored_by='lifecycle'.

        ab_engine.complete_test forwards its `source_actor` kwarg (default
        'lifecycle') straight into `playbook_writer.upsert_recommendation` as
        `authored_by`. This test pins that the default value ('lifecycle') makes
        ...
        assert new_id == 99
        params = sess.calls[0]["params"]
        assert params["authored_by"] == "lifecycle"
    ...
    def test_operator_actor_is_preserved(self):
        ...
        # Crucially NOT 'lifecycle' — the operator handle survives the call.
        assert params["authored_by"] != "lifecycle"
