"""
Lifecycle scenario suite — priority-list graphs tested end-to-end.

Each scenario seeds a realistic subscriber into the DB, dispatches the
trigger event through the Lifecycle supervisor, and asserts the effects are
visible in two tables:

  - agent_decisions    (Lifecycle's audit trail)
