"""Add decision_id to cora_event_queue (Redis-down fallback correctness).

The Postgres fallback path (publish_cora_event -> cora_event_queue ->
...
Usage:
    PYTHONPATH=. python migrations/apply_cora_event_queue_decision_id.py
"""
...
DDL = [
    "ALTER TABLE cora_event_queue ADD COLUMN IF NOT EXISTS decision_id VARCHAR(36);",
]
...
def main() -> None:
    ...
    logger.info("cora_event_queue.decision_id migration complete.")
