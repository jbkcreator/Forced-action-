...
def _dispatch(
    ...
    *,
    ...
    if dry_run:
        ...
        logger.info(
            "reactivation_scheduler: [dry-run] would publish cohort=%s channel=%s sub_id=%s",
            cohort, channel_hint, sub.id,
        )
        return True
...
def run(
    ...
    Args:
        cohort:    "county_live" | "sold_out" | "all"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--cohort",
        choices=["county_live", "sold_out", "all"],
        default="all",
