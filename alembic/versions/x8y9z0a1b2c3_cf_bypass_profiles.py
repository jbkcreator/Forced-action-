...
Revision ID: x8y9z0a1b2c3_cf
Revises:     w7x8y9z0a1b2_pw_history
...
revision = "x8y9z0a1b2c3_cf"
down_revision = "w7x8y9z0a1b2_pw_history"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=False, server_default="540",   # 9 hours
        ),
        # Phase 2: zipped profile backup. NULL = no backup yet.
